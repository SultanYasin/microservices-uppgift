...
public abstract class AbstractTodoAppTest {
    ...
    private final String USERNAME_FOR_TEST = "sss@sss.com";
    private final String PASSWORD_FOR_TEST = "sss";
    ...
    @Before
    public void setup() {
        final AppUser user = new AppUser(USERNAME_FOR_TEST, new BCryptPasswordEncoder().encode(PASSWORD_FOR_TEST), "sss");
        user.setId("111");
